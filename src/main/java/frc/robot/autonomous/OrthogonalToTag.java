...
//   /**
//    * This command should rotate the robot such that it is orthogonal to the AprilTag in its
// vision.
//    * UNTESTED
//    */
...
//     /**
//      * Quick explanation if any of y'all are curious: getBestCameraToTarget() returns a
// Transform3d
//      * object, that represents the transformation vector you can apply to the camera which will
//      * become the camera position. We can apply the .getRotation() decorator to get the
// Rotation3d,
//      * but we only need Rotation2d so we can apply the .toRotation2d decorator, and then get it
// in
//      * degrees with .getDegrees(). So if we think about this as the angle between the 2 poses, it
//      * should look somewhat like the picture I attached. So, subtracting 90 degrees and getting
// the
//      * complementary angle would get us the right angle. Stick on a negative cause it should be
//      * negative according to that coordinate system and I'm just going to assume that this is
// common
//      * for all cases.
//      */
//     target =
...
//             -target.get().getBestCameraToTarget().getRotation().toRotation2d().getDegrees() -
// 180);
...
//               // I subtracted it from 90 because if you really really really think about it then
// you
