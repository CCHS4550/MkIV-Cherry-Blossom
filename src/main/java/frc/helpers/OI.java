...
public class OI {
  ...
  /**
   * @param index The index of the controller whose inputs should be used (Generally, 0 is for drive
   *     train and 1 is for mechanisms)
   ...
   * @param index The index of the controller whose inputs should be used (Generally, 0 is for drive
   *     train and 1 is for mechanisms)
   * @return The direction in degrees of the DPad. 0 is up and increases in 45 degree increments
   *     clockwise. Returns -1 if DPad is not being pressed.
   */
   ...
   * @param index The index of the controller whose inputs should be used (Generally, 0 is for drive
   *     train and 1 is for mechanisms)
   * @param axis The axis that you are checking. On the X-Box controllers, LT and RT count as
   *     triggers. Use ControlMap constants.
  ...
  public static double axis(int index, int axis) {
    ...
    if (axisVal < ControlMap.ZERO && axisVal > -ControlMap.ZERO) return 0;
    else return axisVal;
  }
